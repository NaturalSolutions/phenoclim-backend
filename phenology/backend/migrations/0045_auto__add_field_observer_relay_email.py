...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Observer.relay_email'
        db.add_column(u'backend_observer', 'relay_email',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Observer.relay_email'
        db.delete_column(u'backend_observer', 'relay_email')
    ...
    models = {
        ...
        u'backend.observer': {
            ...
            'logo': ('django.db.models.fields.files.ImageField', [], {'default': "'default_logo.png'", 'max_length': '100'}),
            ...
            'relay_email': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'web_site': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'})
        },
        u'backend.snowing': {

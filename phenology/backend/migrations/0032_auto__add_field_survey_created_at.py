...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.created_at'
        db.add_column(u'backend_survey', 'created_at',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.created_at'
        db.delete_column(u'backend_survey', 'created_at')
    ...
    models = {
        ...
        u'backend.survey': {
            ...
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now', 'db_index': 'True', 'blank': 'True'}),

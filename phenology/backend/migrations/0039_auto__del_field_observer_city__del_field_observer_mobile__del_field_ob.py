...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Observer.city'
        db.delete_column(u'backend_observer', 'city')
    ...
    def backwards(self, orm):
        # Adding field 'Observer.city'
        db.add_column(u'backend_observer', 'city',
        ...
        db.add_column(u'backend_observer', 'adresse',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=80),
                      keep_default=False)

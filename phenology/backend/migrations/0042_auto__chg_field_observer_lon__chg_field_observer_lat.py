...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observer.lon'
        db.alter_column(u'backend_observer', 'lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Observer.lat'
        db.alter_column(u'backend_observer', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Observer.lon'
        db.alter_column(u'backend_observer', 'lon', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Observer.lat'
        db.alter_column(u'backend_observer', 'lat', self.gf('django.db.models.fields.FloatField')())

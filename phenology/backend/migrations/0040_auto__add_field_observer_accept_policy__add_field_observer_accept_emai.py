...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Observer.accept_policy'
        db.add_column(u'backend_observer', 'accept_policy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Observer.accept_email'
        db.add_column(u'backend_observer', 'accept_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Observer.accept_newsletter'
        db.add_column(u'backend_observer', 'accept_newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Observer.accept_policy'
        db.delete_column(u'backend_observer', 'accept_policy')

        # Deleting field 'Observer.accept_email'
        db.delete_column(u'backend_observer', 'accept_email')

        # Deleting field 'Observer.accept_newsletter'
        db.delete_column(u'backend_observer', 'accept_newsletter')
    ...
    models = {
        ...
        u'backend.observer': {
            ...
            'accept_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'accept_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'accept_policy': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'backend_survey', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Removing index on 'Survey', fields ['created_at']
        db.delete_index(u'backend_survey', ['created_at'])


    def backwards(self, orm):
        # Adding index on 'Survey', fields ['created_at']
        db.create_index(u'backend_survey', ['created_at'])

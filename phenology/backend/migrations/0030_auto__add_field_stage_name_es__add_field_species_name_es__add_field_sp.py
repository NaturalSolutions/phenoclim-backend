...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stage.name_es'
        db.add_column(u'backend_stage', 'name_es',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.name_es'
        db.add_column(u'backend_species', 'name_es',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.description_es'
        db.add_column(u'backend_species', 'description_es',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stage.name_es'
        db.delete_column(u'backend_stage', 'name_es')

        # Deleting field 'Species.name_es'
        db.delete_column(u'backend_species', 'name_es')

        # Deleting field 'Species.description_es'
        db.delete_column(u'backend_species', 'description_es')

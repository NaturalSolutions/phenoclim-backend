...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.status'
        db.add_column(u'backend_survey', 'status',
                      self.gf('django.db.models.fields.CharField')(default='a_valider', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.status'
        db.delete_column(u'backend_survey', 'status')
    ...
    models = {
        ...
        u'backend.survey': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'a_valider'", 'max_length': '100', 'blank': 'True'})
        },

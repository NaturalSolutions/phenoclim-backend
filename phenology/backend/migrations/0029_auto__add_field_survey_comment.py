...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.comment'
        db.add_column(u'backend_survey', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=240, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.comment'
        db.delete_column(u'backend_survey', 'comment')

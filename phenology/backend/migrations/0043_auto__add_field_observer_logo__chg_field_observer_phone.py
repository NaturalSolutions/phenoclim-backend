...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observer.phone'
        db.alter_column(u'backend_observer', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):
        # Deleting field 'Observer.logo'
        db.delete_column(u'backend_observer', 'logo')


        # Changing field 'Observer.phone'
        db.alter_column(u'backend_observer', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))

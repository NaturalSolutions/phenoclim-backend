...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Species', fields ['name_ca']
        db.create_index(u'backend_species', ['name_ca'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Species', fields ['name_ca']
        db.delete_index(u'backend_species', ['name_ca'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Temperature.app_name'
        db.add_column(u'backend_temperature', 'app_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Snowing.app_name'
        db.add_column(u'backend_snowing', 'app_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Survey.app_name'
        db.add_column(u'backend_survey', 'app_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Temperature.app_name'
        db.delete_column(u'backend_temperature', 'app_name')

        # Deleting field 'Snowing.app_name'
        db.delete_column(u'backend_snowing', 'app_name')

        # Deleting field 'Survey.app_name'
        db.delete_column(u'backend_survey', 'app_name')
